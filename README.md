...
To use this library, add the `Partigon .jar` file (found in [Releases](https://github.com/Gameoholic/Partigon/releases)) and `Kotlin` to your plugins folder (Found [here](https://github.com/Gameoholic/PaperKotlin/releases/tag/1.0.0)). Partigon requires the Kotlin stdlib to work. 
